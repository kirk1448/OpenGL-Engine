...
int main(void)
{
    ...
    std::cout << "OpenGL Engine setup succsesfuly !!" << std::endl;

    // TODO: Split the logic of setting up and main window loop
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Render
        // 99,149,238
        glClearColor(99 / 255.0, 149 / 255.0, 238 / 255.0, 1.0f);
